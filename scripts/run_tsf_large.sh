...
models=("PatchTST")
root_paths=("./data/long_term_forecast/weather/" "./data/long_term_forecast/traffic/" "./data/long_term_forecast/electricity/")
data_paths=("weather.csv" "traffic.csv" "electricity") 

...
class MoGLoss(nn.Module):
    def __init__(self):
        super(MoGLoss, self).__init__()
    
    def forward(self, weights, mues, log_sigmas, targets, eps=1e-09):
...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def moe_loss_agressive(self, outputs, expert_unc, expert_weights, batch_y, criterion):
        #loss = criterion(expert_weights, outputs, expert_unc, batch_y)
